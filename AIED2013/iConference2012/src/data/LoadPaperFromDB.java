...
public class LoadPaperFromDB {
	...
	public ArrayList<Paper> getPaperData() {
		...
		public void daytoDate(){
			...
			Datetrans.put("2013-06-10", "Monday, Jun 10");
			Datetrans.put("2013-06-11", "Tuesday, Jun 11");
			Datetrans.put("2013-06-12", "Wednesday, Jun 12");
			Datetrans.put("2013-06-13", "Thursday, Jun 13");
			Datetrans.put("2013-06-14", "Friday, Jun 14");
			
		}
		public void daytoid(){
			Dtrans = new Hashtable<String, String>();
			Dtrans.put("2013-06-10", "1");
			Dtrans.put("2013-06-11", "2");
			Dtrans.put("2013-06-12", "3");
			Dtrans.put("2013-06-13", "4");
		    Dtrans.put("2013-06-14", "5");
